...
namespace nacholibre\DoctrineTranslatableFormBundle\Services;
...
class CountryCodeService {
    function __construct() {
        $this->isoCodeNames = [
            ...
            "lu" => ['name' => 'Luba-Katanga', 'native' => ' {"code":,"name":"","nativeName":""},'],
            ...
            "cu" => ['name' => 'Old Church Slavonic, Church Slavic, Church Slavonic, Old Bulgarian, Old Slavonic', 'native' => 'ѩзыкъ словѣньскъ'],
    ...
    public function getCountryByIso($iso) {
        if (isset($this->isoCodeNames[$iso])) {
            return $this->isoCodeNames[$iso];
        } else {
            return null;
        }
    }
